...
const Products = ({catagory, setProductData}) => {

    const {catagori, img,location, name, orginal_price, resale_price, status, time, title, year}=catagory;
                ...
                <div className="card card-compact bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions mt-5 justify-between">
                            ...
                            <label onClick={()=>setProductData(catagory)} htmlFor="catagori-modal" className="btn bg-gradient-to-r from-violet-500 to-fuchsia-500">Book now</label>
